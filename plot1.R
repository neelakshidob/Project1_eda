setwd("C:/Users/Vikas/Desktop/Akshita Sem 5/DATA SCIENCE/Exploratory data analysis")

# Reads in data from file then subsets data for specified dates
powerDT <- data.table::fread("C:/Users/Vikas/Downloads/exdata_data_household_power_consumption/household_power_consumption.txt", na.strings = "?")
